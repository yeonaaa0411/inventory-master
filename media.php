            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-btn">
                  <!-- Changed color of the file input button while keeping size -->
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr class="list-inline">
              ...
              <td class="text-center">
                <a href="delete_media.php?id=<?php echo (int) $media_file['id'];?>" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs" title="Delete">
