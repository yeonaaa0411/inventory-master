...
<div class="mt-9 ml-6 flex">
    <div class="w-2/4">
        <div class="bg-white shadow-md rounded-lg">
            <div class="custom-header p-4">
                <div class="flex items-center">
                    <span class="glyphicon glyphicon-th" style="font-size: 20px;"></span>
                    <h2 class="text-3xl font-bold ml-2">Update <?php echo remove_junk(ucwords($e_user['name'])); ?> Account</h2>
                </div>
            </div>
            <div class="p-4">
                <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id']; ?>" class="clearfix">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control border rounded w-full py-2 px-3" name="name" value="<?php echo remove_junk(ucwords($e_user['name'])); ?>">
                    </div>

                    <div class="mb-4">
                        <label for="username" class="block text-gray-700 text-sm font-bold mb-2">Username</label>
                        <input type="text" class="form-control border rounded w-full py-2 px-3" name="username" value="<?php echo remove_junk(ucwords($e_user['username'])); ?>">
                    </div>
